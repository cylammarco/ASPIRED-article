...
data = fits.open('v_e_20180810_12_1_0_2.fits.gz')[0].data
...
ax1.imshow(data_logged, origin='lower', aspect='auto')
...
ax2.plot(count_horne86, color='green', label='Horne86', lw=1, ls='dashed')
...
ax3.plot(count_horne86_err, color='green', label='Horne86', lw=1, ls='dashed')
ax3.plot(count_marsh89_err, color='blue', label='Marsh89', lw=1, ls=':')
