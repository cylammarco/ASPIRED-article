...
telescopes. % Will include names in a future (draft) article when the instruments+pipelines are deployed.
...
This paper is organised as follow, in Section \textsection2 we covers the development and
